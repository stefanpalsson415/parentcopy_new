// src/components/relationship/RelationshipAssessment.jsx
...
const RelationshipAssessment = ({ 
  ...
  useEffect(() => {
    ...
    if (previousData?.responses) {
      setResponses(previousData.responses);
    }
  ...
  return (
    <div className="bg-white rounded-lg shadow">
      <div className="p-6">
        <div className="mb-6">
          <h3 className="text-xl font-bold mb-2 font-roboto">Your Relationship Assessment</h3>
          <p className="text-gray-600 font-roboto">
            This assessment helps track your perspective on your relationship for Cycle {cycle}. 
            Your partner will complete their own assessment separately.
          </p>
        </div>
